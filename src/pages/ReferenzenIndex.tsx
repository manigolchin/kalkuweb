...
const DESC =
  'Anonymisierte Cases mit Vorher-/Nachher-Zahlen für Bauunternehmen in 10 Gewerken — Tiefbau, Hochbau, GaLaBau, Elektro, HLS, Trockenbau, Dachdecker, Estrich, Metallbau, Straßenbau.';
