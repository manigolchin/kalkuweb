...
const TOOLS: Tool[] = [
  {
    ...
    name: 'GAEB-Konverter',
    desc: 'GAEB-Dateien (X81–X89, D81–D86, P81–P94, ÖNorm A2063) im Browser öffnen, in Excel, PDF, GAEB XML oder GAEB 90 wandeln — und direkt in unseren Kalkulator übergeben.',
    badge: 'Im Browser',
    features: ['6 Zielformate inkl. PDF + GAEB-XML', 'Direkt-Übergabe an Kalkulator', 'Datei verlässt nie Ihren PC'],
    accent: 'emerald',
  },
  {
    to: '/tools/kalkulator/',
    ...
    desc: 'EP/GP berechnen aus Lohn × Zeit + Material + Zuschlag. Mit Trade-Vorlagen, Schlussblatt (Nachlass/Skonto/W&G) und GAEB-Import aus dem Konverter.',
    badge: 'Im Browser',
    features: ['Schlussblatt: W&G · Nachlass · Skonto', 'GAEB-Import aus Konverter', 'Excel + CSV Export'],
    accent: 'sky',
  },
  {
    to: '/tools/mittellohn/',
    ...
    desc: 'Mittellohn AS und ASL aus Team-Mix. BRTV-Bau Lohngruppen-Vorlagen Tarif 2026, Lohnnebenkosten-Breakdown, Excel-Export.',
    badge: 'Im Browser',
    features: ['BRTV-Bau Tarif 2026 (LG 1–6)', 'Team-Vorlagen Kolonnen-Mix', 'AS + ASL Berechnung'],
    accent: 'amber',
  },
  {
    ...
    desc: 'Werktage-Countdown, deutsche Feiertage je Bundesland, VOB/A § 12a Mindestfrist-Prüfung, Bindefrist-Tracking, ICS-Export.',
    badge: 'Im Browser',
    features: ['VOB/A § 12a Mindestfrist', 'Bindefrist-Tracking', 'ICS-Kalender-Export'],
    accent: 'rose',
  },
  {
    ...
    desc: 'Vertragserfüllungs- und Gewährleistungs-Bürgschaft nach VOB/B § 17, Avalprovision über volle Laufzeit, plus Bareinbehalt-Vergleich.',
    badge: 'Im Browser',
    features: ['Bareinbehalt-vs-Bürgschaft-Vergleich', '„Auf erstes Anfordern"-Aufpreis', 'Szenarien Konservativ/Markt/Optimal'],
    accent: 'indigo',
  },
];
